...
type LayoutRouteId = RouteId | "/" | "/dashboard" | "/delivery" | "/inventory" | "/kitchen-monitor" | "/login" | "/main-pos" | "/register" | "/return" | "/sidebar" | "/transaction" | "/vouchers" | "/waiter-monitor" | null
